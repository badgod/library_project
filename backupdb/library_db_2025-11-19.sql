...
--
-- Host: localhost:8889
-- Generation Time: Nov 19, 2025 at 07:26 AM
...
CREATE TABLE `member` (
  ...
  `staus` enum('active','inactive') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'สถานะ (''active'', ''inactive'', ''pending'')'
