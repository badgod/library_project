...
<head>
    ...
    <meta name="description" content="ระบบจัดการห้องสมุดภายในหน่วยงาน" />
    <meta name="author" content="Your Team Name" />
    <title>ระบบจัดการห้องสมุด (LMS)</title>
    ...
    <style>
        ...
        /* [START] โค้ดปรับความชัดเจนของข้อความบนสไลด์ */
        .carousel-caption h1,
        .carousel-caption p {
            text-shadow: 2px 2px 5px rgba(0, 0, 0, 0.8);
            /* เพิ่มเงาข้อความสีดำเข้ม */
        }

        /* [END] โค้ดปรับความชัดเจนของข้อความบนสไลด์ */
    </style>
                ...
                <div class="carousel-item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption text-start">
                            ...
                            <p>
                                <a class="btn btn-lg btn-primary" href="#">เข้าสู่ระบบเพื่อใช้บริการ</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    ...
                    <div class="container">
                        <div class="carousel-caption text-end">
                            <h1>บริการออนไลน์สำหรับการยืมหนังสือ</h1>
                            <p>
                                ตรวจสอบสถานะการยืมหนังสือและประวัติการยืมของคุณได้อย่างง่ายดาย
                            </p>
                            <p>
